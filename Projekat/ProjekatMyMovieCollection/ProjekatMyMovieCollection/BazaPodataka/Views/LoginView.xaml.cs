...
namespace ProjekatMyMovieCollection.BazaPodataka.Views
{
    public sealed partial class KorisnikListView : Page
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                RIS.ItemsSource = db.Korisnik.OrderBy(c => c.Naziv).ToList();
            }
        }
        ...
        private void buttonDodaj_Click(object sender, RoutedEventArgs e)
        {
            using (var db = new RestoranDbContext())
            {
                var contact = new Restoran
                {
                    ...
                    GeoDuzina = (float)Convert.ToDouble(GeoDuzinaInput.Text), Add-Migration 
